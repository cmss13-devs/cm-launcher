...
export type AppSettings = { auth_mode: AuthMode; theme?: Theme; notification_servers?: string[] }
...
export type LauncherFeatures = { relay_selector: boolean; singleplayer: boolean; server_search: boolean; server_filters: boolean; show_offline_servers: boolean; server_stats: boolean; auto_launch_byond: boolean; connection_timeout_fallback: boolean }
...
export type ReleaseInfo = { tag_name: string; name: string; published_at: string; download_url: string | null; size: number | null }
export type Server = { id: string | null; name: string; url: string; status: string; hub_status?: string; players?: number; data?: ServerData | null; is_18_plus?: boolean; version?: string | null; engine?: EngineRequirements | null; tags?: string[]; auth_methods?: string[]; description?: string | null; links?: ServerLink[] }
